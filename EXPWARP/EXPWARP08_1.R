...
cat("Experiment EXPWARP08_1 starts!\n")
ptm <- proc.time()
...
for(tter in 1:length(vT)) for(nter in 1:length(vN)){
  ...
  sfExport(list=c("fTF","WCBHETest","sLMTEST","EstPSTR","DerGFunc","iT","iN","GA","vc","msigma","B01","B1","ikk","Theta","kappa","chS"))
...
save.image("RESULTS/EXPWARP08_1.RData")
